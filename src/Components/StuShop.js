  ...
  render() {
    return (
      ...
      <div className="section_3">
        <div className="arrowDown"><img src={require("../Icons/icon-angle-arrow-down-green.png")} alt="Green down arrow"></img></div>
          <div className="row">
            <div className="column colStuShop">
              <img src={require("../Images/buyCoffee.jpg")} alt="Buy Coffee" className="buyCoffee"></img>
              <h4>Shop Coffee</h4>
              <hr/>
